    ...
    async setup() {
        ...
        const LOCALES = {
			...
			fr: {
                ...
                matchWidth:  "Même largeur (plus large)",
                deselect:    "Tout désélectionner",
                scaleDown:   "Réduire l'échelle",
                scaleUp:     "Augmenter l'échelle",
            },
			zh: {
                alignLeft:   "左对齐",
                alignRight:  "右对齐",
            ...
            it: {
                ...
                matchWidth:  "Uniforma larghezza (più largo)",
                deselect:    "Deseleziona tutto",
                scaleDown:   "Rimpicciolisci",
                scaleUp:     "Ingrandisci",
            },
            uk: {
                ...
                distributeH: "Рівномірний розподіл по горизонталі",
                distributeV: "Рівномірний розподіл по вертикалі",
